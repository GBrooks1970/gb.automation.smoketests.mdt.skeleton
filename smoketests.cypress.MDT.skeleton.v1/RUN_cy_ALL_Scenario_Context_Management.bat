@echo off
REM ============================
REM Batch Script for Running `npm run cy:ALL_Scenario_Context_Management`
...
set outputFile=cy_results_ALL_Scenario_Context_Management_%datetime%.txt

REM Run the npm command and redirect output to the timestamped file
npm run cy:ALL_Scenario_Context_Management > %outputFile%
